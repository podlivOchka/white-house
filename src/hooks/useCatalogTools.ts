...
useEffect(()=>{
 ...
 if(data.maxPrice!==undefined&&(typeof data.maxPrice!=="number"||!Number.isFinite(data.maxPrice)||data.maxPrice<0||data.maxPrice>14000))throw new Error("Invalid price");
