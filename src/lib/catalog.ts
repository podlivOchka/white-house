import {products,type Category,type View} from "../data/catalog.ts";
export type Sort="default"|"price-asc"|"price-desc"|"name";
export type Filters={category:Category;query:string;color:string;maxPrice:number;sort:Sort};
export const defaults:Filters={category:"Все",query:"",color:"",maxPrice:14000,sort:"default"};
...
if(filters.maxPrice<14000&&(p.price===null||p.price>filters.maxPrice))return false;
