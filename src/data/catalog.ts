...
export type Product = { id:string; name:string; category:Exclude<Category,"Все">; price:number|null; image:string; colors:string[]; label?:string; isNew?:boolean; collection?:boolean; description:string; availability?:"in-stock"|"out-of-stock"; hidden?:boolean };
...
export const seedProducts:Product[]=structuredClone(products);
